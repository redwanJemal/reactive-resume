		...
		<SectionBase type="information" className="space-y-4">
			<div className="space-y-2 rounded-md border bg-sky-600 p-5 text-white dark:bg-sky-700">
				...
				<div className="space-y-2 text-xs leading-normal">
					<Trans>
						<p>
							Thank you for using NoorCV! This app is a labor of love, created mostly in my spare time, with wonderful
							support from open-source contributors around the world.
						</p>
						<p>
							If NoorCV has been helpful to you, and you'd like to help keep it free and open for everyone, please
